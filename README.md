...
Для хранения аналитических данных нам понадобится ClikHouse со следующими двумя таблицами.
![Статистика действий пользователя](img/videos_sheme.jpg)
![Данные о видео](img/actions_sheme.jpg)
...
На каждом из 18 физическом сервере мы настроим 50 сегментов для осуществления процесса виртуального разбиения данных. В качестве ключа разбиения используем user_id – это уникальный идентификатор пользователя.
